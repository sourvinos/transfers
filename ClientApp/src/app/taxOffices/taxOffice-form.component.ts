...
export class TaxOfficeFormComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(private taxOfficeService: TaxOfficeService, private helperService: HelperService, private formBuilder: FormBuilder, private router: Router, private route: ActivatedRoute, private modalService: BsModalService, private keyboardShortcutsService: KeyboardShortcuts) {
