...
const appRoutes: Routes = [
	...
	{ path: 'customers', component: CustomerListComponent, canActivate: [AuthGuardService] }, { path: 'customers/new', component: CustomerFormComponent, canActivate: [AuthGuardService], canDeactivate: [AuthGuardService] }, { path: 'customers/:id', component: CustomerFormComponent, canActivate: [AuthGuardService], canDeactivate: [AuthGuardService] },
	{ path: 'destinations', component: DestinationListComponent, canActivate: [AuthGuardService] }, { path: 'destinations/new', component: DestinationFormComponent, canActivate: [AuthGuardService], canDeactivate: [AuthGuardService] }, { path: 'destinations/:id', component: DestinationFormComponent, canActivate: [AuthGuardService], canDeactivate: [AuthGuardService] },
	{ path: 'drivers', component: DriverListComponent, canActivate: [AuthGuardService] }, { path: 'drivers/new', component: DriverFormComponent, canActivate: [AuthGuardService], canDeactivate: [AuthGuardService] }, { path: 'drivers/:id', component: DriverFormComponent, canActivate: [AuthGuardService], canDeactivate: [AuthGuardService] },
	{ path: 'pickupPoints', component: PickupPointListComponent, canActivate: [AuthGuardService] }, { path: 'pickupPoints/new', component: PickupPointFormComponent, canActivate: [AuthGuardService], canDeactivate: [AuthGuardService] }, { path: 'pickupPoints/:id', component: PickupPointFormComponent, canActivate: [AuthGuardService], canDeactivate: [AuthGuardService] },
	{ path: 'ports', component: PortListComponent, canActivate: [AuthGuardService] }, { path: 'ports/new', component: PortFormComponent, canActivate: [AuthGuardService], canDeactivate: [AuthGuardService] }, { path: 'ports/:id', component: PortFormComponent, canActivate: [AuthGuardService], canDeactivate: [AuthGuardService] },
	{ path: 'routes', component: RouteListComponent, canActivate: [AuthGuardService] }, { path: 'routes/new', component: RouteFormComponent, canActivate: [AuthGuardService], canDeactivate: [AuthGuardService] }, { path: 'routes/:id', component: RouteFormComponent, canActivate: [AuthGuardService], canDeactivate: [AuthGuardService] },
